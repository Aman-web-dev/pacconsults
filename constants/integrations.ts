...
export const INTEGRATIONS: Integration[] = [
    ...
    {
        name: "Snapchat",
        description: "Automate your workflows by connecting Pac Consulting with thousands of apps through Snapchat.",
        icon: "/icons/snapchat.svg",
        category: "api"
    },
    {
        name: "Reddit",
        description: "Share and engage with the Reddit community directly from your Pac Consulting dashboard.",
