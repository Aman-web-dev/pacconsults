...
// Placeholder STATS array - replace with actual content for PAC Consultants
const STATS = [
    {
        value: "20+",
        title: "Years of Experience",
        icon: "/icons/moon.svg", // Placeholder image
    },
    {
        value: "500+",
        title: "Businesses Funded",
        icon: "/icons/stars.svg", // Placeholder image
    },
    {
        value: "95%",
        title: "Client Satisfaction",
        icon: "/icons/edit.svg", // Placeholder image
    },
];
