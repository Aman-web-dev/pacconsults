                ...
                <Container>
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Proven results across thousands of successful business transactions
                        </p>
                    </div>
                </Container>
                
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-8 place-items-center w-full">
                        ...
                        >
                            <div className="flex flex-col items-center justify-center">
                                ...
                                <div className="text-center">
                                    <h4 className="text-lg lg:text-2xl text-transparent bg-linear-to-b from-neutral-100 to bg-neutral-500 bg-clip-text font-semibold mt-5">
                                        {stat.value}
                                    </h4>
