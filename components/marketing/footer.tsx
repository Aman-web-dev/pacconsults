                    ...
                    <Container animation="fadeRight" delay={0.4}>
                        <div className="flex flex-col items-start justify-start md:max-w-[300px]">
                            ...
                            <p className="text-muted-foreground mt-4 text-sm">
                                Sell your business or secure funding <br />—without the guesswork
                            </p>
                ...
                <Container animation="fadeUp" delay={1}>
                    <div className="mt-16 border-t border-border/80 pt-8 flex flex-col md:flex-row items-center justify-center">
                        <p className="text-sm text-muted-foreground">
                            © {new Date().getFullYear()} PAC Consulting. All rights reserved. | Privacy Policy | Schedule a Call | About PAC
                        </p>
                    </div>
                </Container>
            </Wrapper>
