...
const Hero = () => {
  return (
    <div className="relative z-0 w-full h-full bg-[#090909]">
        ...
        <div className="flex flex-col items-center justify-center w-full z-10">
          <Container>
            <div className="flex items-center justify-center gap-x-1 px-2 py-1.5 relative w-max mx-auto rounded-full before:absolute before:inset-0 before:-z-10 before:p-[1px] before:rounded-3xl before:bg-gradient-to-b before:from-neutral-700 before:to-neutral-900 before:content-[''] after:absolute after:inset-[1px] after:-z-10 after:rounded-[22px] after:bg-[#181818]/60">
              <Star className="size-5 border-amber-300 text-amber-300" />
              <span className="text-sm text-white">
                Pac Consultants Overview
              </span>
            </div>
          </Container>

          <Container delay={0.1}>
            <h2 className="text-balance text-white !leading-[1.25] text-center text-5xl md:text-6xl font-semibold tracking-tight mt-6 w-full">
              Sell Your Business or <br className="hidden lg:inline-block" />{" "}
              Secure Funding Without the Guesswork.
            </h2>
          </Container>
          ...
          {/* <Container delay={0.3}>
            <div className="mt-6">
              <Button size="default">Book a Call</Button>
            </div>
          </Container> */}
          <Container delay={0.3}>
          <button className="relative mt-4 inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
            <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#f5f5f5_0%,#51e0cc_50%,#f5f5f5_100%)]" />
